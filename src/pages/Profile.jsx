            ...
            <div className="w-full h-full flex flex-col lg:flex-row py-4 justify-center equal-row">
                <div className="flex flex-col w-auto mx-2 2xl:w-1/5">
                    <div className="dark:bg-darkBlue rounded-lg p-4 flex flex-col mb-2">
                        ...
                        <div className="">
                            <h3 className="font-semibold text-lg font-itc uppercase mt-4">password modification</h3>
                ...
                <div className="flex flex-col w-auto mx-2 2xl:w-1/5">
                    <div className="dark:bg-darkBlue rounded-lg p-4 flex flex-col mb-2">
                        ...
                        <label className="text-white text-base mt-2 font-medium mb-1">2FA QRCode:</label>
                        {url_data?.getOtpUrl && <div className="flex  justify-center">
                            {console.log(me)}
